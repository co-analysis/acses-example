...
From this page you can download the raw statistical tables that make up the Civil Service Statistics.

You can download the full file, or use the interactive table below to filter the data and select only the tables of interest.

```{=html}
{{< download_file link="https://assets.publishing.service.gov.uk/government/uploads/system/uploads/attachment_data/file/836368/Statistical-tables-Civil-Service-Statistics-2019-machine-readable-headcounts-version-V2.csv" text="Machine readable format tables for Civil Service Statistics 2019" type="CSV" size="3.8MB" >}}
```
...
unstrap(fs_grade)
unstrap(fs_sex)
unstrap(fs_ethnicity)
unstrap(fs_disability)
```
:::
